...
const translations: Record<Language, Record<string, string>> = {
  vi: {
    ...
    "profile.groomSide": "Nhà trai",
    "profile.brideSide": "Nhà gái",
    ...
    "profile.monday": "Thứ Hai",
    "profile.tuesday": "Thứ Ba",
    "profile.saturday": "Thứ Bảy",
    "profile.sunday": "Chủ Nhật",
    "profile.datePrefix": "ngày",
    ...
    "profile.invitation": "Thư Mời",
    "profile.joinUs": "Tham dự lễ cưới",
    "profile.atTime": "Vào Lúc",
    "profile.hour": "giờ",
    "profile.month": "Tháng",
    "profile.year": "Năm",
    "profile.groomSideLabel": "NHÀ TRAI",
    "profile.brideSideLabel": "NHÀ GÁI",
    "profile.groomLocation": "Tại Tư Gia Nhà Trai",
    "profile.brideLocation": "Tại Tư Gia Nhà Gái",
    ...
    "profile.groomQuote": "Hôn nhân là chuyện cả đời, Yêu người vừa ý, cưới người mình thương...",
    "profile.brideQuote": "Đủ nắng hoa sẽ nở, Đủ yêu thương hạnh phúc sẽ đong đầy...",
    "profile.groomName": "Hoàng Trung Quân",
    "profile.groomName.v2": "Trung Quân",
    "profile.groomTitle": "(Quý Nam)",
    "profile.groomFather": "Hoàng Văn Đoàn",
    "profile.groomMother": "Lê Thị Quy",
    "profile.groomAddress": "Thôn Phú Kinh, xã Bắc Trạch, tỉnh Quảng Trị",
    "profile.groomAddressDetail": "(Thôn Phú Kinh, xã Liên Trạch, huyện Bố Trạch, tỉnh Quảng Bình cũ)",
    "profile.groomReceptionAddress": "Thôn Phú Kinh, xã Bắc Trạch, tỉnh Quảng Trị",
    "profile.brideName": "Nguyễn Thị Yến Nhi",
    "profile.brideName.v2": "Yến Nhi",
    "profile.brideTitle": "(Quý Nữ)",
    "profile.brideFather": "Nguyễn Đức Thạnh",
    "profile.brideMother": "Lê Thị Tuyết My",
    "profile.brideAddress": "Thôn Mỹ Chánh, xã Nam Hải Lăng, tỉnh Quảng Trị",
    "profile.brideAddressDetail": "(Thôn Mỹ Chánh, xã Hải Chánh, huyện Hải Lăng, tỉnh Quảng Trị cũ)",
    "profile.brideReceptionAddress": "Thôn Mỹ Chánh, xã Nam Hải Lăng, tỉnh Quảng Trị",
    ...
    "parallax.subtext": "Mãi mãi, bắt đầu từ ngày hôm nay",
    ...
    // Modal
    "modal.reception": "Tiệc mừng (Reception)",
  ...
  en: {
    ...
    "profile.joinUs": "Join us to celebrate the wedding of",
    "profile.atTime": "At",
    "profile.hour": "o'clock",
    "profile.month": "Month",
    "profile.year": "Year",
    "profile.groomSideLabel": "GROOM'S SIDE",
    "profile.brideSideLabel": "BRIDE'S SIDE",
    "profile.groomLocation": "At Groom's Residence",
    "profile.brideLocation": "At Bride's Residence",
    ...
    "profile.groomQuote": "Marriage is a lifelong journey, love the right one, marry the loved one...",
    "profile.brideQuote": "With enough sun, flowers bloom. With enough love, happiness overflows...",
    "profile.groomName": "Hoang Trung Quan",
    "profile.groomName.v2": "Trung Quan",
    "profile.groomTitle": "(The Groom)",
    "profile.groomFather": "Hoang Van Doan",
    "profile.groomMother": "Le Thi Quy",
    "profile.groomAddress": "Phu Kinh Village, Bac Trach Commune, Quang Tri Province",
    "profile.groomAddressDetail": "(Phu Kinh Village, Lien Trach Commune, Bo Trach District, former Quang Tri Province)",
    "profile.groomReceptionAddress": "Phu Kinh Village, Bac Trach Commune, Bo Trach District, Quang Tri Province",
    "profile.brideName": "Nguyễn Thị Yến Nhi",
    "profile.brideName.v2": "Yến Nhi",
    "profile.brideTitle": "(The Bride)",
    "profile.brideFather": "Nguyen Duc Thanh",
    "profile.brideMother": "Le Thi Tuyet My",
    "profile.brideAddress": "My Chanh Village, Nam Hai Lang Commune, Quang Tri Province",
    "profile.brideAddressDetail": "(My Chanh Village, Hai Chanh Commune, Hai Lang District, former Quang Tri Province)",
    "profile.brideReceptionAddress": "My Chanh Village, Nam Hai Lang Commune, Quang Tri Province",
